...
const data = [
    {id: 0, img: "product__5.jpeg", name: "Fresh Tomato", price: "$400"},
    {id: 0, img: "product__2.jpeg", name: "Crunchy Crisps", price: "$300"},
    {id: 0, img: "product__3.jpeg", name: "Jewel Cranberries", price: "$200"},
    {id: 0, img: "product__4.jpeg", name: "Almond Organic", price: "$100"},
]
